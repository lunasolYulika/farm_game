...
def get_huertas(juego):
    ...
    for index_h in range(3):
        ...
        for i_c in range(len(set_coord_superpuestas)):
            ...
            if es_repetida == False and set_coord_superpuestas[i_c].fila in range(TAMAÑO_MATRIZ) and set_coord_superpuestas[i_c].columna in range(TAMAÑO_MATRIZ) and es_coord_repetida(set_coord_superpuestas[i_c],CULTIVO,index_h,juego) == False:
